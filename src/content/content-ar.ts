...
export const tool: _tool = {
  PDF_to_HTML: {
    title: "PDF إلى HTML",
    seoTitle: "تحويل PDF إلى HTML عبر الإنترنت - محول PDF إلى HTML | PDFEquips",
    ...
    features: [
      {
        ...
        description: "لا حاجة للتسجيل أو إعطائنا أي معلومات لتغيير ملف PDF الخاص بك إلى HTML. محولنا مجاني للجميع وسريع جدًا."
      },
      {
        title: "إدارة المستندات الآمنة.",
        description: "يتم معالجة تنزيلاتك والملفات التي تم إنشاؤها بتشفير TLS وتتم حذفها على الفور لزيادة الأمان. تحقق من سياسة الخصوصية لدينا للمزيد من المعلومات."
      },
      {
        title: "معالجة قائمة على السحابة.",
        description: "أحد المزايا الرئيسية لخدمتنا عبر الإنترنت هو أن جميع تحويلات PDF إلى HTML تتم في السحابة. هذا يعني أنه لن يبطئ جهاز الكمبيوتر الخاص بك، ويمكنك استخدام خدمتنا من أي مكان وفي أي وقت."
      }
    ]
